...
namespace GsalesPro
{
    public partial class PesquisaClienteCpf : MetroFramework.Forms.MetroForm
    {
        public PesquisaClienteCpf()
        {
            InitializeComponent();
        }
        public string result = "";
        private void PesquisaClienteCpf_Load(object sender, EventArgs e)
        {
